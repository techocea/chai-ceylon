...
const CTASection = ({
  ...
  return (
    <div className="wrapper px-0">
      <div className="relative bg-accent py-12 px-6 lg:py-16 flex flex-col items-center justify-center w-full sm:px-4">
        <Image
          src="/images/pattern.png"
          width={1920}
          height={400}
          className="absolute inset-0 w-full h-full object-cover opacity-15 pointer-events-none rounded-xl"
